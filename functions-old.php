...
add_action( 'admin_init', 'remove_google' );
function remove_google(){
  remove_menu_page( 'gadash_settings' );
  //admin.php?page=gadash_settings
  //admin.php?page=gadash_backend_settings
  //admin.php?page=gadash_frontend_settings
  //admin.php?page=gadash_tracking_settings
  //admin.php?page=gadash_errors_debugging
}
